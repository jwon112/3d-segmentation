...
class DualBranchUNet3D_DilatedMobile_Small(nn.Module):
    """Dual-branch UNet with dilated FLAIR branch + MobileNetV2 backbone (Small)."""
...
class DualBranchUNet3D_DilatedMobile_Medium(nn.Module):
    """Dual-branch UNet with dilated FLAIR branch + MobileNetV2 backbone (Medium)."""
    ...
    def __init__(self, n_channels: int = 2, n_classes: int = 4, norm: str = 'bn', bilinear: bool = False, expand_ratio: float = 4.0):
        ...
        self.branch_flair4 = Down3DStrideDilated(128, 256, norm=self.norm)
...
__all__ = [
    'DualBranchUNet3D_DilatedMobile_Small',
